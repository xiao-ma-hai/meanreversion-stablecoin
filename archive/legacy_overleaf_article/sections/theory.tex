...
\fi
\section{Mean-Reverting Markov Processes}
\label{sec:mean-reverting-markov}
...
\subsection{Notions and characterizations of mean reversion}
...
\label{sec:diffusion-transforms}
...
General solution methods for the linear partial differential equations used in
the transform calculations are collected in \citet{PolyaninNazaikinskii2015}.
...
\label{sec:mixed-copula-processes}
...
\subsection{Risk-neutral bond pricing with reset risk}
...
$R_t=\mathcal R_{0,t}=\exp\{\int_0^t\gamma(a)\dd a\}$ and define
\[
